...
*
* -插件命令 
* 【插件命令】Text1和text2分两个阶段设置，并显示带有Face ID号的角色的脸图。 
* PushGab FaceID text1|text2
...
* @default gab_bg
* @param GabWindowYpadd_originalSkin
* @desc 在“使用原始 UI 图像”的情况下，每个gab窗口的附加垂直填充。（默认值：0） 
* @default 0
* @type number
*
* @param GabSoundSE
* @desc SE用于插入每个Gab窗口（默认值：无） 
* @type file
* @dir audio/se
*
* @param GabWindowY
